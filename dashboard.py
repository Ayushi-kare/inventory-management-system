...
class IMS:
    def __init__(self, root):
        ...
        lbl_menu=Label(LeftMenu,text="Menu", font=("times now roman",20),bg="#009688").pack(side=TOP, fill=X)
        ...
        btn_sales=Button(LeftMenu,text="Sales", command=self.sales,image=self.icon_side,compound=LEFT,padx=5, anchor="w", font=("times now roman",20,"bold"),bg="white", bd=3,cursor="hand2").pack(side=TOP, fill=X)
        ...
        #===footer===
        lbl_footer=Label(self.root,text="IMS- Inventory Management System \n For any Technical Issue Contact: 987XXXXX10 ",font=("times new roman", 10),bg="#4d636d", fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
#==========================================================================================================================================================================================================       
